...
const {getLoansForAdmin, getAcceptedLoansForAdmin, getLoan, getIssuer, getLender, approveLoan, getApprovedLoansForAdmin, getActiveLoansForAdmin, getComplaints, getTax, updateTax} = require('../controllers/admin');
